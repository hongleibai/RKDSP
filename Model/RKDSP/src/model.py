...
class RKDSP_dis(nn.Module):
    def __init__(self, in_ft, out_ft, layers, act='prelu', bias=True, idx=0):  # 100, 100, 2
        super(RKDSP_dis, self).__init__()
        self.layers = layers  # 2
        self.in_ft = in_ft
        self.out_ft = out_ft
        self.gcn_list = []
...
class RKDSP_se(nn.Module):
    def __init__(self, in_ft, out_ft, layers, act='prelu', bias=True, idx=0):  # 100, 100, 2
        super(RKDSP_se, self).__init__()
        self.layers = layers  # 2
        self.in_ft = in_ft
        self.out_ft = out_ft
        self.gcn_list = []
