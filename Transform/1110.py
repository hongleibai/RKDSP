...
model_data_folder = f'{model_folder}/RKDSP/data/ACM/link'  # Model/RKDSP/data/ACM/
dataset = 'ACM'
version = 'link'
...
model_data_folder = f'{model_folder}/RKDSP/data/{dataset}/{version}'  # Model/RKDSP/data/ACM/
...
print(f'RKDSP: writing {dataset}\'s config file!')
...
print('RKDSP Link: converting {}\'s node file for {} training!'.format(dataset,
                                                                     'attributed' ))
...
print(f'RKDSP Link: converting {dataset}\'s label file')
...
print(f'RKDSP: converting {dataset}\'s link file!')
