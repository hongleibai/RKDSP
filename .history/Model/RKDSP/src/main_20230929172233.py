...
def parse_args():
    ...
    parser.add_argument('--dim', type=int, default=2400)  # output emb size
...
class SCConv(nn.Module): 
    def __init__(self):
        ...
        self.conv5 = nn.Sequential(
            nn.Conv2d(1, 16, kernel_size=(2, 2), stride=1, padding=1),  
            nn.ReLU(),  
            nn.MaxPool2d(kernel_size=2, stride=1))  

        self.conv6 = nn.Sequential(
            nn.Conv2d(16, 16, kernel_size=(2, 2), stride=2),
            nn.ReLU(),
